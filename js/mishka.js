...
(function() {
    var cardData = [
        card1 = {
            ...
            cardImgMobileWebP: "img/photo-1-mobile.webp 1x, img/photo-1-mobile.webp 2x",
            cardImgTabletWebP: "img/photo-1-tablet.webp 1x, img/photo-1-tablet.webp 2x",
            cardImgdesktopWebP: "img/photo-1-desktop.webp 1x, img/photo-1-desktop.webp 2x",
            cardImgMobile: "img/photo-1-mobile.jpg, img/photo-1-mobile.jpg 2x",
            cardImgTablet: "img/photo-1-tablet.jpg 1x, img/photo-1-tablet.jpg 2x",
            cardImgDesktop2x: "img/photo-1-desktop.jpg 2x",
        ...
        card2 = {
            ...
            cardImgMobileWebP: "img/photo-2-mobile.webp 1x, img/photo-2-mobile.webp 2x",
            cardImgTabletWebP: "img/photo-2-tablet.webp 1x, img/photo-2-tablet.webp 2x",
            cardImgdesktopWebP: "img/photo-2-desktop.webp 1x, img/photo-2-desktop.webp 2x",
            cardImgMobile: "img/photo-2-mobile.jpg, img/photo-2-mobile.jpg 2x",
            cardImgTablet: "img/photo-2-tablet.jpg 1x, img/photo-2-tablet.jpg 2x",
            cardImgDesktop2x: "img/photo-2-desktop.jpg 2x",
        ...
        card3 = {
            ...
            cardImgMobileWebP: "img/photo-3-mobile.webp 1x, img/photo-3-mobile.webp 2x",
            cardImgTabletWebP: "img/photo-3-tablet.webp 1x, img/photo-3-tablet.webp 2x",
            cardImgdesktopWebP: "img/photo-3-desktop.webp 1x, img/photo-3-desktop.webp 2x",
            cardImgMobile: "img/photo-3-mobile.jpg, img/photo-3-mobile.jpg 2x",
            cardImgTablet: "img/photo-3-tablet.jpg 1x, img/photo-3-tablet.jpg 2x",
            cardImgDesktop2x: "img/photo-3-desktop.jpg 2x",
